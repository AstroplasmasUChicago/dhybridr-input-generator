...
const SCHEMA = {
  ...
  ext_force: {
    ...
    fields: [
      ...
      { key: 'kmin', label: 'kmin', type: 'real', dim: 0, default: 1, hint: 'TURB: minimum |k| of driven shell', advanced: true },
      { key: 'kmax', label: 'kmax', type: 'real', dim: 0, default: 5, hint: 'TURB: maximum |k| of driven shell', advanced: true },
