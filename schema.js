...
const SCHEMA = {
  ...
  species: {
    ...
    groups: [
      ...
      { title: 'Velocity', keys: ['vdrift','vth','vth_par','vsp','vnorm','match_velocity_to_gravity','pl_slope','pl_min','pl_max'] },
    ...
    fields: [
      ...
      { key: 'vth_par', label: 'vth_par', type: 'real', dim: 0, default: 0, hint: 'Parallel thermal velocity (BIMAXWELLIAN only; <=0 falls back to vth = isotropic)', advanced: true },
